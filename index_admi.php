            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="index_admi.php"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            $sql = "SELECT estado, count('nro_spl') as numero FROM `planilla` GROUP BY `estado`";
                ...
                <!-- /.row -->
                                    ...
                                    <div class="panel-body">
                                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            $sql = "SELECT meta, count('nro_spl') as numero FROM `planilla` GROUP BY `meta`";

                                            $esta1 = "";
                                            $nspl1 = "";

                                            $resultado1 = @mysql_query($sql,$enlace);
                                            //$result = mysql_query($sql); //Ejecución de la consulta
                                                  if (@mysql_num_rows($resultado1) > 0){ 
                                                     // Se recoge el número de resultados
                                                     // Se almacenan las cadenas de resultado
                                                     while($fila2 = @mysql_fetch_assoc($resultado1)){ 
                                                        $meta1 = $fila2['meta'];
                                                        $nspl1 = $fila2['numero'];
                                             ?>
                                                <tr class="odd gradeA">
                                                    <td><?php echo $meta1; ?></td>
                                                    <td><?php echo $nspl1; ?></td>                                                   
                                                </tr>
                                                <?php 
                                                  }
                                                 }
