            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="wizard-header">
                        ...
                        <p class="category">Revisión de datos y cerrar Rendición - <B>CONTROL PREVIO.</p></B>
                        <P></P>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            $sql_ren = "SELECT a.*, b.* FROM planilla a, rendiciones b WHERE a.estado='Por Rendir' and a.nro_spl=$busqueda and a.nro_spl=b.nro_spl order by fecha";
