            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="wizard-header">
                        ...
                        <p class="category">Actualización de datos <B>TESORERIA.</p></B>
                        <P></P>
                       ...
                       <div class="row">
                        ...
                        <form role="form" action="vupdate1.php" method="post">
                            <label>COMPROBANTE DE PAGO : </label>
                            <input type="text" class="form-control" placeholder="Nro de Comprobante de Pago..." name="pago">
                            <p></p>
